...
const Translations = {
  ...
  en: {
    ...
    PAY_FOR_VOUCHER: 'Pay For Voucher',
    ...
    toast: {
      error: {
        ...
        TOKEN_NOT_SHARABLE: "Token is not allowed to be transferred."
      },
      success: {
        SUCCESS: 'Success',
  ...
  es: {
    buttons: {
      INSERT_COIN: 'Inserte Una Moneda',
      CONNECT: 'Conectar',
      ...
      IM_DONE_PAYING: `He terminado de pagar`,
    ...
    AMOUNT: 'Cantidad',
    TIME: 'Hora',
    INSERT_COIN_NOW: 'Inserte Moneda Ahora',
    PAY_FOR_VOUCHER: 'Pagar por el Voucher',
    ...
    toast: {
      error: {
        ...
        TOKEN_NOT_SHARABLE: "El token no está permitido ser transferido"
      },
      success: {
        SUCCESS: 'Éxito',
        ...
        TOKEN_ACTIVATED: 'Token activado correctamente',
